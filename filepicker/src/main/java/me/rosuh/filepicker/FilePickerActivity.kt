...
class FilePickerActivity : AppCompatActivity(), View.OnClickListener,
    ...
    private fun initView() {
        ...
        weixin.setOnClickListener(this@FilePickerActivity);
    ...
    private fun enterDirAndUpdateUI(fileBean: FileBean) {
        Log.e("test",fileBean.fileName+" "+fileBean.filePath);
        // 清除当前选中状态
        resetViewState()
    ...
    override fun onClick(v: View?) {
        when (v!!.id) {
            ...
            R.id.weixin->{
                val item = FileNavBeanImpl("Download","/storage/emulated/0/Android/data/com.tencent.mm/MicroMsg/Download");
                item.beanSubscriber = this;
                enterDirAndUpdateUI(item)
            }
        }
    }
